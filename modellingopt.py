...
# set uri MLFlow tracking + nama experiment
...
# variabel buat nyatet kombinasi param & akurasi terbaik 
best_accuracy = 0
best_params = {}
...
for n_estimators in n_estimators_range:
    for max_depth in max_depth_range:
        # function buat general ML + MLFlow
        # train, log, & simpen model pake MLFlow
